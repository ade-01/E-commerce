...
import Image1 from '../../assets/shop_top.webp';
import Image2 from '../../assets/shop_left.avif';
                ...
                <div className='category'>
                    ...
                    <div className='box'>
                        <ul>
                            ...
                            <li onClick={() => Filter ("phone case")}># phone case</li>
                            <li onClick={() => Filter ("accessories")}># accessories</li>
                            <li onClick={() => Filter ("wears")}># wears</li>
                        </ul>
                    </div>
                </div>
