...
import Testimonial from '../../assets/T1.avif';
              ...
              <div className='right_container'>
                <div className='testimonial'>
                  ...
                  <div className='detail'>
                    <div className='img_box'>
                      <img src={Testimonial} alt='testmonial'></img>
                    </div>
                    <div className='info'>
                      <h3>stephan hollywood</h3>
                      <h4>web designer</h4>
                      <p>This has to be the most affordable and easy to navigate site </p>
                    </div>
                  </div>
                </div>
